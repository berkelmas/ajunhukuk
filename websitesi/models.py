...
class isilanlari(models.Model):
    ...
    isilani_isim = models.CharField(('İş İlanı Başlığı'), max_length=150)
    isilani_aciklama = RichTextField()

    def __str__(self):
        return self.isilani_isim
...
class Contact(models.Model):
    ...
    iletisim_konu = models.CharField(('Konu'), max_length=100)
...
class Makaleler(models.Model):
    ...
    KATEGORILER = (
        ...
        ('trafikhukuku', 'Trafik Sigorta Hukuku'),
